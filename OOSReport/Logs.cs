...
namespace OOSReport.Analytics
{
    ...
    public class Logs
    {
        ...
        public Logs(string reportStatusOk, int logsCount, string reportStatusError, string generalError, int reportID, int lastID)
        {
        ...
        public static void CreateFile(string FileEntry)
        {
            ...
            string docPath = ConfigurationManager.AppSettings["LogFilePath"];
        ...
        {
            string logReport = "Report status for store ID " + ReportID + ": " + ReportStatusOk;          
        ...
        {
            string logReport = "Report status for store ID " + ReportID + ": " + ReportStatusError;
            Console.WriteLine(logReport);
            return logReport;
        }
        ...
        public static string LogGeneralErrorReport()
        {
            ...
            CatmanErrorLogger.LogCatmanError(report);           
            return report;
        }
    }
}
